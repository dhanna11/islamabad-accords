# The Islamabad Accords · plain-text edition
...
A Peace Plan Synthesized for Donald Trump
...
ARCHITECTURAL PHASE
five institutions · five trades
~15 YEARS
the waypoint · regional détente
20 TO 30 YEARS
the capstone · full regional normalization
THE SET
1
The Transactional Phase
a ceasefire and three deals · freeze Hormuz, de-escalate the nuclear file, rebuild the Middle East
2
The Architectural Phase
five institutions · the generational settlement
3
The Architectural Phase
five trades · what each side actually commits
4
The Generational Horizon
the waypoint and the capstone
5
...
1
THE GAP
- A deal without a vision will not last · we have already seen that with the MoU
- Moving forward takes two things: a vision and political will
- Plenty of regional architectures have been proposed: a Helsinki process, which the Saudis now push as Helsinki-lite · an ASEAN Regional Forum for the Gulf · Iran’s Hormuz Peace Endeavour
- None of them are Trump-flavored, and no credentialed analyst has proposed such a thing
2
WHY HIM
...
- Its contours already existed: the previous administration, regional partners, and Blair’s GITA
- His goals are well known: contain Iran’s nuclear program and expand normalization · the architecture is an implementation detail
...
A recommitment to the cessation of armed hostilities across all fronts, Gaza and Lebanon included, to be formalized into the All-Fronts Hudna, the war-ending armistice, in the architectural phase.
...
$15B+
RELEASES
- Released to Iran without restriction on use
- These are Iran's own assets, unfrozen under the MoU ¶11 procedure
FIGURES TRACK AMOUNTS REPORTED BY AXIOS DURING THE 2026 NUCLEAR NEGOTIATIONS

RECONSTRUCTION TRANCHE
the mutual down payment on regional stability
$25B
of Iran's frozen assets, on agreement of the architectural phase
AT LEAST A 25% SHARE · PUBLIC TRUST
$6.25B
CARVE-OUT
...
What Each Side Actually Commits
every track is an exchange, and the layer beneath them all
TRACK
IRAN & ITS ALLIES COMMIT
...
- Every other facility sealed under continuous IAEA watch
- Zero HEU for the duration
- The existing stockpile part downblended in place and kept under seal, the rest exported to Consortium custody
⇄
- Recognition of Iran's right to enrich under the NPT, via the Consortium, including on Iranian soil
- Then a supervised ramp to a 1.5–3.67% ceiling
- Saudi Arabia and any other domestic enrichment program under the same verification
- The three nuclear gates of card 1 paid as each closes
HORMUZ
in the Commission
- The strait reopens in practice
- Joint mine-clearing, naval deconfliction, and free, non-discriminatory flow of commerce
- Return to the IMO traffic separation scheme once the architecture stands
⇄
- Iranian and Omani sovereign rights openly acknowledged
- A transit revenue framework carriers can pay into without sanctions exposure
- The Malacca Cooperative Mechanism as precedent
ARMS & PRESENCE
in the Forum
- Restraint on short- & medium-range missiles and drones
- No intercontinental development, ever
- Limits on arming non-state actors
⇄
- Economic and diplomatic integration
- Restraint on American military presence and regional arsenals, negotiated in the Forum
- The same limits on arming non-state actors
RECONSTRUCTION
in the Fund
- A 25% carve-out from every asset release beyond the nuclear gates, roughly $20B across the lifetime of the architecture, into the public trust for Gaza & Lebanon
⇄
- The remaining 75% released to Iran
- Dollar-for-dollar match by the Board of Peace, roughly $20B across the lifetime of the architecture, on top of the $17B already pledged
- A ~$500B regional program folding in Iran's own ~$300B rebuild, weighted toward cross-border infrastructure
THE ONE COUPLING, NOT DESIGNED · AMERICAN FINANCIAL LEVERAGE TOUCHES EVERY TRACK
...
BREACH
- Breaches are inevitable as sides continually assess the architecture's value
- What the institutions cannot contain goes to the Table for intensive mediation
TERMINATION
- Waivers first
- Permanent termination only when the architecture's record supports the certification to Congress
...
The Waypoint and the Capstone
whatever portion of the horizon the region actually gets, verified progress is kept
~15 YEARS
THE REALISTIC OUTCOME
Regional Détente
- Fifteen years without major conflict, alongside real if uneven progress across the five tracks
- Major incidents are expected · the institutions exist to keep them from cascading into another regional war
- Near-zero enrichment gives way to the supervised ramp
20 TO 30 YEARS
THE CATASTROPHIC SUCCESS
Full Regional Normalization
- Diplomatic relations among all the states of the region, with the end of US-Iran enmity as the keystone
- Not warmth · a channel that holds under stress
- A Middle East where every capital can reach every other in an emergency
- A Middle East that secures itself · regional rivalries settled at its own table
EARNED ON THE CUMULATIVE RECORD · GENERATED BY THE INSTITUTIONS, NOT CLAIMED
◆NO WEAPONS-GRADE ENRICHMENT
◆NO UNAUTHORIZED STOCKPILING
◆NO INTERCONTINENTAL DEVELOPMENT
◆NO PROHIBITED PROLIFERATION
◆GOOD-FAITH HUDNA PERFORMANCE
...
LIMITS
Stated Up Front
seven things this framework does not claim
IT NEEDS TRUMP
...
- Every element can be undone by a party willing to pay the cost
- What the architecture changes is how slow, how visible, and how damaging reversal becomes
- Finality has chargebacks, and geopolitics files more of them than finance does
- And finality covers acts, not conditions: compliance is continuous, so a party that stops performing ends the series, and ending the series can undo much of what it was building
NO CENTRAL ENFORCEMENT
- The institutions negotiate standards and produce receipts, not adjudications
...
THE FAULT LINES ARE ENTRENCHED
- Israeli-Palestinian, Sunni-Shia, US-Iran, Arab-Persian, Islamic-Western
- The architecture can only attempt to contain them
DÉTENTE IS MUTUAL, NOT PROMISED
...
[Better Order Project · Nov 2024 · Quincy Proposal 20: a permanent regional security organization with Iran in it](https://betterorderproject.org/regional-flashpoints-and-ordering/)
[Carnegie · Mar 2025 · An OSCE-model body open to all regional states, Israel and Iran included](https://carnegieendowment.org/research/2025/03/ending-the-new-wars-of-attrition-opportunities-for-collective-regional-security-in-the-middle-east)
...
[The National · 26 May 2026 · Iran’s $24B ask: $12B at signing, $12B within 60 days](https://www.thenationalnews.com/news/mena/2026/05/26/the-24bn-question-iran-pushes-us-to-release-frozen-funds-in-qatar-talks/)
[Times of Israel (NYT) · 29 May 2026 · A $300B postwar investment fund in the draft MoU](https://www.timesofisrael.com/liveblog_entry/emerging-us-iran-mou-said-to-reference-possible-300b-postwar-investment-fund-to-aid-tehrans-reconstruction/)
[Fortune (Bloomberg) · 7 Jun 2026 · Treasury floats steering frozen Iranian assets to Gulf repairs](https://fortune.com/2026/06/07/us-frozen-iran-assets-gulf-allies-reconstruction-treasury-secretary-bessent/)
[Truth Social · 10 Aug 2026 · Trump: Iran “responsible for the damages and death” in Lebanon, Syria, Yemen, Gaza](https://truthsocial.com/@realDonaldTrump/117072424154442498)
ARMS & PRESENCE · the Forum
...
Slides that appear only in the deck.
...
- The reconstruction formula gives him the politically defensible story the asset release otherwise lacks
- A 25% carve-out from every release beyond the nuclear gates, into the public trust for Gaza & Lebanon, matched dollar for dollar by the Board of Peace
- A much-needed capital injection into the 20-point plan

### The carve-out closes two-thirds of the gap
*Reconstruction Tranche · the arithmetic*
- Need: about $82B · Gaza $71.4B (EU, UN and World Bank, Apr 2026) · Lebanon about $11B (World Bank, Mar 2025, before the 2026 fighting)
